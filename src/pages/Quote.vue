<template>
  <div>
    <!-- Hero Section Quote -->
    <div id="hero-quote" class="bg-[#0A4A6B] relative -mt-32 pt-0 overflow-hidden">
      <!-- Background elements -->
    ...
    <!-- Info Section -->
    <section id="info-section" class="bg-[#016E98] py-20 md:py-32 relative overflow-hidden mx-4 md:mx-8 rounded-3xl my-16 md:my-24 shadow-2xl border border-blue-800/50">
      <!-- Background elements -->
